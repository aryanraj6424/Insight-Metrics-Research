...
//   // email js yaha pe add ho raha hai
...
//     { year: "2026", name: "Kerala Assembly Elections" }
//   ];
...
//         focus:border-[#009ADE] outline-none text-white font-medium w-full placeholder-white/70"
//       />

//       {/* name="phone" matching {{phone}} */}
//       <input
//         type="tel"
//         name="phone"
//         placeholder="Phone"
...
//       focus:border-[#009ADE] outline-none text-white font-medium placeholder-white/70"
//     />

//     {/* NEW: name="title" matching {{title}} in your template */}
//     <input
//       type="text"
//       name="title"
//       placeholder="Subject / Service Title"
//       required
//       className="w-full bg-transparent border-b border-white/20 pb-3 md:pb-4 
//       focus:border-[#009ADE] outline-none text-white font-medium placeholder-white/70"
//     />

//     {/* name="message" matching {{message}} */}
//     <textarea
//       name="message"
...
//     >
//       {sending ? "Sending..." : "Send Briefing Request"}
//     </button>
...
import DonationStrip from '../components/DonationStrip';
import { Page } from '../App';
import { useForm, ValidationError } from '@formspree/react'; // Formspree added
import { 
  ArrowRight, CheckCircle, Database, Users, Target, Layout, 
  Share2, Monitor, Trophy, Mail, Phone, MapPin, ArrowLeft,
  Briefcase, BarChart3, Star
...
const HomeView: React.FC<HomeViewProps> = ({ onNavigate }) => {
  ...
  // Formspree logic replacing EmailJS
              ...
              <div className="space-y-5 md:space-y-6">
                <div className="flex items-center gap-4 md:gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-xl font-bold break-all">insightmetrics1@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 md:gap-6">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-[#009ADE]/20 rounded-2xl flex items-center justify-center text-[#009ADE]">
                  ...
                  <div>
                    <p className="text-[10px] md:text-xs font-black uppercase tracking-widest text-gray-400">Call Now</p>
                    <p className="text-base md:text-xl font-bold leading-snug">+91 89433 23509 <br/> +91 99979 19080</p>
                  </div>
                </div>
              </div>
            </div>

            {/* RIGHT FORM - Formspree Integrated */}
            <div className="bg-white/5 backdrop-blur-md rounded-[2rem] md:rounded-[3rem] 
            p-6 sm:p-8 md:p-10 lg:p-12 border border-white/10 relative z-10">

              {state.succeeded ? (
                <div className="text-center py-10">
                  <CheckCircle className="w-16 h-16 text-[#009ADE] mx-auto mb-4" />
                  <h3 className="text-2xl font-bold text-white">Message Sent!</h3>
                  <p className="text-gray-400 mt-2">Thank you. We will contact you soon.</p>
                  <button onClick={() => window.location.reload()} className="mt-6 text-[#009ADE] underline">Send another</button>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
                    <input
                      ...
                      placeholder="Name"
                      required
                      className="bg-transparent border-b border-white/20 pb-3 md:pb-4 focus:border-[#009ADE] outline-none text-white font-medium w-full placeholder-white/70"
                    />
                    <input
                      type="tel"
                      name="phone"
                  ...
                  <div className="space-y-1">
                    <input
                      ...
                      placeholder="Email"
                      required
                      className="w-full bg-transparent border-b border-white/20 pb-3 md:pb-4 focus:border-[#009ADE] outline-none text-white font-medium placeholder-white/70"
                    />
                  ...
                  <button
                    ...
                    disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {state.submitting ? "Sending..." : "Send Briefing Request"}
                  </button>
                </form>
              )}
            </div>
